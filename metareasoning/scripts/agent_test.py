...
def main():
    ...
    fake_action_list = [
        ...
        },
        {
            ...
            'constraints':
            agent.Constraints(
                block=kb.Block(length=4, width=1, color="green"),
                position=None,
                orientation=0),
            'desc':
            "Moving towards 1x4 green",
        },
        {
            'action':
        ...
        },
        {
            ...
            agent.Constraints(
                ...
                orientation=0),
            'desc':
            "Moving 1x4 green at x=0, y=-0.3, z=-0.16",
        },
        {
            'action':
            kb.PrimitiveActions.align,
            'constraints':
            agent.Constraints(block=None, position=None, orientation=0),
            'desc':
            "Aligning 1x4 green wiht block_orientation 0",
        },
        {
        ...
        },
        {
            ...
            'constraints':
            agent.Constraints(
                block=kb.Block(length=2, width=1, color="red"),
                position=None,
                orientation=0),
            'desc':
            "Moving towards 1x2 red",
        },
        {
            'action':
            kb.PrimitiveActions.align,
        ...
        },
        {
            ...
            agent.Constraints(
                ...
                orientation=0),
            'desc':
            "Moving 1x2 red at x=0, y=-0.3, z=-0.16",
        },
        {
            'action':
            kb.PrimitiveActions.align,
            ...
            agent.Constraints(block=None, position=None, orientation=0),
            'desc':
            "Aligning 1x2 red with block_orientation 0",
        },
        {
            'action': kb.PrimitiveActions.place,
            'constraints': agent.Constraints(),
