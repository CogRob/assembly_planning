...
def main():
    ...
    blue_1x4_pnp = generate_pick_and_place(
        blue_1x4, blue_1x4_final_position, 0, 0)

    red_1x2_pnp = generate_pick_and_place(
        red_1x2, red_1x2_final_position, 0, 1)
    ...
    green_1x2_block = kb.Block(length=4, width=1, color="green",
    ...
    node_condition1 = iso.categorical_node_match(['length', 'width'],
                                                 [1, 1])
    ...
    print("Result 1: ", result1, " and Result 2: ", result2,
          " Result 3: ", result3, " and sum ", result)
